...
public class TreatmentPlan {
	...
	private static final String LOWER_BACK_INJURY_PHASE1 = "LUMBAR STRAIN_1";	//LOWER BACK INJURY
	private static final String LOWER_BACK_INJURY_PHASE2 = "LUMBAR STRAIN_2";	//LOWER BACK INJURY
	private static final String LOWER_BACK_INJURY_PHASE3 = "LUMBAR STRAIN_3";	//LOWER BACK INJURY
	private static final String SHOULDER_INJURY_PHASE1 = "ROTATOR CUFF TEAR_1";	//SHOULDER INJURY
	private static final String SHOULDER_INJURY_PHASE2 = "ROTATOR CUFF TEAR_2";	//SHOULDER INJURY
	private static final String SHOULDER_INJURY_PHASE3 = "ROTATOR CUFF TEAR_3";	//SHOULDER INJURY
	...
	private ArrayList<String> TREATMENT_PLAN_LOWER_BACK;	// = new ArrayList<String>();
	private ArrayList<String> TREATMENT_PLAN_SHOULDER;	// = new ArrayList<String>();
	...
	public String determineSpecificTreatment(Patient_Notes patientNotes){
		...
		if ((patientNotes.getPain() >= 7) && (patientNotes.getPain() <=10) && (patientNotes.getStrength() >= 0) && (patientNotes.getStrength() <= 3) && (patientNotes.getRangeOfMotion() >= getRom_min_val()) && (patientNotes.getRangeOfMotion() <= getRom_mid_val1())){
		...
		else if ((patientNotes.getPain() >= 3) && (patientNotes.getPain() <=6) && (patientNotes.getStrength() >= 4) && (patientNotes.getStrength() <= 7) && (patientNotes.getRangeOfMotion() > getRom_mid_val1()) && (patientNotes.getRangeOfMotion() <= getRom_mid_val2())){
		...
		else if ((patientNotes.getPain() >= 0) && (patientNotes.getPain() <=2) && (patientNotes.getStrength() >= 8) && (patientNotes.getStrength() <= 10) && (patientNotes.getRangeOfMotion() > getRom_mid_val2()) && (patientNotes.getRangeOfMotion() <= getRom_max_val())){
	...
	public void pickExerciseRepsAndTime(Patient_Notes patientNotes){
		...
		if (injuryName.equalsIgnoreCase(LOWER_BACK_INJURY) && (phaseOfTreatment.equalsIgnoreCase(PHASE1)))
			val = 1;
		else if (injuryName.equalsIgnoreCase(LOWER_BACK_INJURY) && (phaseOfTreatment.equalsIgnoreCase(PHASE2)))
			val = 2;
		else if (injuryName.equalsIgnoreCase(LOWER_BACK_INJURY) && (phaseOfTreatment.equalsIgnoreCase(PHASE3)))
			val = 3;
		else if (injuryName.equalsIgnoreCase(SHOULDER_INJURY) && (phaseOfTreatment.equalsIgnoreCase(PHASE1)))
			val = 4;
		else if (injuryName.equalsIgnoreCase(SHOULDER_INJURY) && (phaseOfTreatment.equalsIgnoreCase(PHASE2)))
			val = 5;
		else if (injuryName.equalsIgnoreCase(SHOULDER_INJURY) && (phaseOfTreatment.equalsIgnoreCase(PHASE3)))
			val = 6;
		else if (injuryName.equalsIgnoreCase(ACL_INJURY) && (phaseOfTreatment.equalsIgnoreCase(PHASE1)))
			val = 7;
		else if (injuryName.equalsIgnoreCase(ACL_INJURY) && (phaseOfTreatment.equalsIgnoreCase(PHASE2)))
			val = 8;
		else if (injuryName.equalsIgnoreCase(ACL_INJURY) && (phaseOfTreatment.equalsIgnoreCase(PHASE3)))
			val = 9;
